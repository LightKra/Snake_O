...
const drawSnake = ()=>{
    snake.forEach(square => drawSquares(square, 'snakeSquare'));
}
const drawSquares = (square, type)=>{
...
const moveSnake = ()=>{
    ...
    if(newSquare < 0 || newSquare > boardSize * boardSize ||
        ...
        if(boardSquares[row][column] === squareTypes.foodSquare){
            ...
            drawSquares(emptySquare, 'emptySquare');
        }
        drawSnake();
    }
}
...
const createRandomFood = ()=>{
    ...
    drawSquares(randomEmptySquares, 'foodSquare');
}
